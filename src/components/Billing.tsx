        ...
        >
          ...
          <div className="flex-1 flex justify-center items-start flex-col">
            ...
            <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
              <Image src={apple} alt="apple" className="w-[128px] h-[42px] object-contain mr-5 cursor-pointer"/>
              <Image src={google} alt="google" className="w-[128px] h-[42px] object-contain cursor-pointer"/>
            </div>
          </div>
        </section>
      </div>
